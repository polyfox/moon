...
text_add_text(mrb_state* mrb, mrb_value self)
{
  ...
  mrb_float line_height =
    mrb_to_flo(mrb, moon_iv_get(mrb, self, "@line_height"));
  ...
  Moon::Vector4 color =
    *mmrb_vector4_ptr(mrb, moon_iv_get(mrb, self, "@color"));
  Moon::Vector4 outline_color =
    *mmrb_vector4_ptr(mrb, moon_iv_get(mrb, self, "@outline_color"));
...
mmrb_text_init(mrb_state* mrb)
{
  ...
  struct RClass* text_cls =
    mrb_define_class_under(mrb, mod, "Text", mrb->object_class);
