...
#define m_vector_operator(__op__)                                              \
  return mmrb_vector3_value(mrb, get_vector3_value(mrb, self)                  \
                                   __op__ vector3_from_mrb_args(mrb));

#define m_vector_int_operator(__op__)                                          \
  return mmrb_vector3_value(                                                   \
    mrb, Moon::Vector3(glm::ivec3(get_vector3_value(mrb, self))                \
                         __op__ glm::ivec3(vector3_from_mrb_args(mrb))));
...
MOON_C_API const struct mrb_data_type vector3_data_type = { "Moon::Vector3",
                                                            vector3_free };

DEF_VEC_HELPERS(vector3, Moon::Vector3, mmrb_get_vector3_class(mrb),
                &vector3_data_type);
...
{
  cleanup_vector3(mrb, self);
  mrb_data_init(self, new Moon::Vector3(vector3_from_mrb_args(mrb)),
                &vector3_data_type);
  return self;
}
...
vector3_eq(mrb_state* mrb, mrb_value self)
{
  ...
  if (mrb_obj_is_kind_of(mrb, other, mmrb_get_vector3_class(mrb))) {
    return mrb_bool_value((*mmrb_vector3_ptr(mrb, self)) ==
                          (*mmrb_vector3_ptr(mrb, other)));
  }
...
{
  return mmrb_vector3_value(
    mrb, Moon::Vector3(~(glm::ivec3(*mmrb_vector3_ptr(mrb, self)))));
}
...
vector3_distance(mrb_state* mrb, mrb_value self)
{
  ...
  return mrb_float_value(mrb,
                         glm::distance(get_vector3_value(mrb, self), *other));
}
/*
 * @param [Vector3] other
 * @param [Float] angle
...
vector3_rotate(mrb_state* mrb, mrb_value self)
{
  ...
  return mmrb_vector3_value(
    mrb, glm::rotate(*mmrb_vector3_ptr(mrb, self), (float)angle, *other));
}
...
vector3_rotate_x(mrb_state* mrb, mrb_value self)
{
  ...
  return mmrb_vector3_value(
    mrb, glm::rotateX(*mmrb_vector3_ptr(mrb, self), (float)angle));
}
...
vector3_rotate_y(mrb_state* mrb, mrb_value self)
{
  ...
  mrb_get_args(mrb, "f", &angle);
  return mmrb_vector3_value(
    mrb, glm::rotateY(*mmrb_vector3_ptr(mrb, self), (float)angle));
}
...
vector3_rotate_z(mrb_state* mrb, mrb_value self)
{
  ...
  mrb_get_args(mrb, "f", &angle);
  return mmrb_vector3_value(
    mrb, glm::rotateZ(*mmrb_vector3_ptr(mrb, self), (float)angle));
}
 ...
 * @param [Float] delta Interpolation factor. The interpolation is defined in
 * the range [0, 1].
 * @return [Vector3]
 */
static mrb_value
vector3_lerp(mrb_state* mrb, mrb_value self)
{
  ...
  return mmrb_vector3_value(
    mrb, glm::lerp(*mmrb_vector3_ptr(mrb, self), *other, (float)delta));
}
 ...
 *
 * The interpolation always take the short path and the rotation is performed at
 * constant speed.
 *
 * @param [Vector3] other quaternion
 * @param [Float] delta Interpolation factor. The interpolation is defined
...
vector3_slerp(mrb_state* mrb, mrb_value self)
{
  ...
  mrb_get_args(mrb, "df", &other, &vector3_data_type, &delta);
  return mmrb_vector3_value(
    mrb, glm::slerp(*mmrb_vector3_ptr(mrb, self), *other, (float)delta));
}
...
mmrb_vector3_init(mrb_state* mrb)
{
  ...
  struct RClass* vector3_class =
    mrb_define_class_under(mrb, mod, "Vector3", mrb->object_class);
  MRB_SET_INSTANCE_TT(vector3_class, MRB_TT_DATA);

  mrb_define_method(mrb, vector3_class, "initialize", vector3_initialize,
                    MRB_ARGS_OPT(3));
  mrb_define_method(mrb, vector3_class, "initialize_copy",
                    vector3_initialize_copy, MRB_ARGS_REQ(1));
  /* coercion */
  mrb_define_method(mrb, vector3_class, "coerce", vector3_coerce,
                    MRB_ARGS_REQ(1));
  ...
  mrb_define_method(mrb, vector3_class, "+@", vector3_identity,
                    MRB_ARGS_NONE());
  ...
  mrb_define_method(mrb, vector3_class, "cross", vector3_cross,
                    MRB_ARGS_REQ(1));
  /* */
  mrb_define_method(mrb, vector3_class, "normalize", vector3_normalize,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, vector3_class, "length", vector3_length,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, vector3_class, "distance", vector3_distance,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, vector3_class, "rotate", vector3_rotate,
                    MRB_ARGS_REQ(2));
  mrb_define_method(mrb, vector3_class, "rotate_x", vector3_rotate_x,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, vector3_class, "rotate_y", vector3_rotate_y,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, vector3_class, "rotate_z", vector3_rotate_z,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, vector3_class, "lerp", vector3_lerp, MRB_ARGS_REQ(2));
  mrb_define_method(mrb, vector3_class, "slerp", vector3_slerp,
                    MRB_ARGS_REQ(2));
  /* bitwise operators */
  ...
  /* cast */
  mrb_define_class_method(mrb, vector3_class, "[]", vector3_s_cast,
                          MRB_ARGS_ANY());
  mrb_define_class_method(mrb, vector3_class, "extract", vector3_s_extract,
                          MRB_ARGS_REQ(1));

  mrb_alias_method(mrb, vector3_class, mrb_intern_cstr(mrb, "r"),
                   mrb_intern_cstr(mrb, "x"));
  mrb_alias_method(mrb, vector3_class, mrb_intern_cstr(mrb, "g"),
                   mrb_intern_cstr(mrb, "y"));
  mrb_alias_method(mrb, vector3_class, mrb_intern_cstr(mrb, "b"),
