...
namespace Moon {
  ...
  void Input::initialize_maps() {
    ...
    glfw_key_map[GLFW_KEY_0] = mrb_symbol_value(mrb_intern_cstr(mrb, "0"));
    glfw_key_map[GLFW_KEY_1] = mrb_symbol_value(mrb_intern_cstr(mrb, "1"));
    glfw_key_map[GLFW_KEY_2] = mrb_symbol_value(mrb_intern_cstr(mrb, "2"));
    glfw_key_map[GLFW_KEY_3] = mrb_symbol_value(mrb_intern_cstr(mrb, "3"));
    glfw_key_map[GLFW_KEY_4] = mrb_symbol_value(mrb_intern_cstr(mrb, "4"));
    glfw_key_map[GLFW_KEY_5] = mrb_symbol_value(mrb_intern_cstr(mrb, "5"));
    glfw_key_map[GLFW_KEY_6] = mrb_symbol_value(mrb_intern_cstr(mrb, "6"));
    glfw_key_map[GLFW_KEY_7] = mrb_symbol_value(mrb_intern_cstr(mrb, "7"));
    glfw_key_map[GLFW_KEY_8] = mrb_symbol_value(mrb_intern_cstr(mrb, "8"));
    glfw_key_map[GLFW_KEY_9] = mrb_symbol_value(mrb_intern_cstr(mrb, "9"));
