...
namespace Moon {
  ...
  public:
    ...
    void render(const GLfloat &x, const GLfloat &y, const GLfloat &z, Rect *clip=NULL);
    void render(const GLfloat &x, const GLfloat &y, const GLfloat &z, const GLuint &vboID, const GLuint &iboID);
