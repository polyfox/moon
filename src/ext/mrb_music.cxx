...
namespace Moon {
  ...
  static mrb_value
  moon_mrb_music_play(mrb_state *mrb, mrb_value klass) {
    char* filename;
    char* format;
  ...
  static mrb_value
  moon_mrb_music_stop(mrb_state *mrb, mrb_value klass) {
    Music::stop();
  ...
  static mrb_value
  moon_mrb_music_is_playing(mrb_state *mrb, mrb_value klass) {
    return mrb_bool_value(Music::is_playing());
  }

  static mrb_value
  moon_mrb_music_is_stopped(mrb_state *mrb, mrb_value klass) {
    return mrb_bool_value(Music::is_stopped());
  }

  static mrb_value
  moon_mrb_music_is_finished(mrb_state *mrb, mrb_value klass) {
    return mrb_bool_value(Music::is_finished());
  }

  static mrb_value
  moon_mrb_music_seek(mrb_state *mrb, mrb_value klass) {
    mrb_int offset;
  ...
  static mrb_value
  moon_mrb_music_pos(mrb_state *mrb, mrb_value klass) {
    return mrb_fixnum_value(Music::pos());
  }

  static mrb_value
  moon_mrb_music_length(mrb_state *mrb, mrb_value klass) {
